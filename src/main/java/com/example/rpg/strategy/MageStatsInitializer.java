...
/**
 * Stratégie d'initialisation pour les classes Mages (BLACK_MAGE, WHITE_MAGE, TIME_MAGE, SUMMONER)
 * Privilégie MA et MP
 */
@Component
public class MageStatsInitializer implements StatsInitializer {
    ...
    public boolean supports(CharacterClass characterClass) {
        return characterClass == CharacterClass.BLACK_MAGE || 
               characterClass == CharacterClass.WHITE_MAGE ||
               characterClass == CharacterClass.TIME_MAGE ||
