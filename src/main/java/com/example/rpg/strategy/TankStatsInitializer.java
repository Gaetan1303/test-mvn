...
/**
 * Stratégie d'initialisation pour les classes Tank (KNIGHT, MONK)
 * Privilégie HP et défense
 */
@Component
public class TankStatsInitializer implements StatsInitializer {
    ...
    public boolean supports(CharacterClass characterClass) {
        return characterClass == CharacterClass.KNIGHT || 
